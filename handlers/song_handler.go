...
func AddSong(w http.ResponseWriter, r *http.Request) {
	...
	_, err = db.Exec("INSERT INTO songs (group_name, song, text, releaseDate, link) VALUES ($1, $2, $3, $4, $5)", song.GroupName, song.Song, song.Text, song.ReleaseDate, song.Link)
	if err != nil {
...
func DeleteSong(w http.ResponseWriter, r *http.Request) {
	...
	var exists bool
	query := `SELECT EXISTS (SELECT 1 FROM songs WHERE group_name=$1 AND song=$2)`
